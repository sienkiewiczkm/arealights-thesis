...
Ciąg Haltona jest uogólnieniem ciągu van der Corput'a do wyższych
...
\begin{figure}[h]
  ...
  \caption{Ciąg Haltona dla $b_1=2\: b_2=3$ (1024 próbek). Opracowanie własne.}
...
Parametry wejściowe $(u,v)$ wygenerujemy za pomocą ciągów pseudo-losowych przedstawionych wcześniej. Obrazki poglądowe wykorzystują ciąg Hammersleya jako generator liczb wejściowych.
